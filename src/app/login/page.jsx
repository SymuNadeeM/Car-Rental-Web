  ...
  return (
    <>
     <div className=' relative '>
          <Image src={inner} alt='' className=' bg-cover w-full  h-screen  brightness-50 ' />
          <div className=' absolute top-0 left-0'> <Navbar />    </div>  
          <div className=' absolute top-[75px]  bottom-[200px]'>
      ...
      {/* <div className=' bg-slate-300 py-[60px] md:py-[90px] px-[30px] md:px-[115px]'>
            <div className=' grid md:grid-cols-3 '>
                    <div className=' grid md:col-span-1'>
                    </div>  
                    <div className=' grid md:col-span-1'>
