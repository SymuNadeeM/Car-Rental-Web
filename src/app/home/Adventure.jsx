  ...
  return (
    ...
    <div>
            <div className=' relative'>
             ...
             <div className=' absolute xs:right-[20px] sm:right-[30px] md:right-[115px] xs:left-[20px] sm:left-[30px] md:left-[115px] top-[90px] bottom-[115px] '>
                  <div className=' grid md:grid-cols-4 gap-[26px]'>
                       <div>
                           <h1 className=' xs:text-[32px] md:text-[52px] tracking-[-2px] mb-[20px] font-[500] xs:leading-[40px] md:leading-[52px] text-white'>Lets Your Adventure Begin</h1>
                       </div>
                       <div>
                         <BsTrophyFill  className=' mb-[20px] p-5 rounded-md flex items-center justify-center xs:text-[40px] xs:h-[50px] xs:w-[50px] md:w-[80px] md:h-[80px] bg-primary-color text-white' />   
                       ...
                       <div>
                         <FaRoad  className=' mb-[20px] p-5 rounded-md flex items-center justify-center xs:text-[32px] xs:h-[50px] xs:w-[50px] md:w-[80px] md:h-[80px] bg-primary-color text-white' />   
                       ...
                       <div>
                         <FaMapPin  className=' mb-[20px] p-5 rounded-md flex items-center justify-center xs:text-[32px] xs:h-[50px] xs:w-[50px] md:w-[80px] md:h-[80px] bg-primary-color text-white' />   
