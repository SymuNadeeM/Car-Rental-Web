    ...
    <>
      <section className=' py-[60px] md:py-[90px] px-[30px] md:px-[115px]'>
             <div className=' text-center flex flex-col items-center justify-center '>
                    <p className=' w-fit font-Inter font-bold bg-gray-text text-primary-color rounded-[5px] px-[10px] py-[2px] mb-[5px]'>Latest From Us</p>
                    <h2 className=' font-semibold text-blue-text mb-[10px] text-[42px] tracking-tight leading-[50px]'>News & Promo</h2>
             ...
             <div className=' mt-[30px] grid md:grid-cols-3 gap-[26px]'>
                 <div className=' relative'>
                    ...
                    <div className=' relative border-b-[2px] border-primary-color pb-[30px] pt-[20px] px-[30px] bg-white mx-[20px] mt-[-40px] mb-0 z-50 rounded-tr-[10px] rounded-tl-[10px] '>
                 ...
                 <div className='relative'>
                    ...
                    <div className=' absolute flex flex-col justify-center items-center top-[20px] left-[20px] w-[54px] h-[63px] rounded-[5px] bg-primary-color text-white '>
                       <h5 className=' font-bold text-[32px] px-[8px] '>12</h5>
                       <p className=' text-[10px] tracking-[5px] font-Inter mb-[8px] ' >MAR</p>
                    </div>
                 </div>
                 <div className='relative'>
