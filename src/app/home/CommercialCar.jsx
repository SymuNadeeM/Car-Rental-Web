    ...
    <>
      ...
      <div>
          <div className=' relative'>
             <Image src={commercialbg} alt='' className=' w-full h-[1330px] md:h-[611px]'   />
             <div className=' absolute right-[30px] md:right-[115px] left-[30px] md:left-[115px] top-[60px] md:top-[90px] bottom-[90px]  '>
